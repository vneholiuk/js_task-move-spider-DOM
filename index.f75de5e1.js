...
document.addEventListener("click", function(e) {
    if (e.target === wall) {
        ...
        if (newLeft + spiderRect.width > WALL_WIDTH) newLeft = WALL_WIDTH - spiderRect.width;
        if (newTop + spiderRect.height > WALL_HEIGHT) newTop = WALL_HEIGHT - spiderRect.height;
